<?php
session_start();
$_SESSION['servicio'] = 'FABRICACIÓN MOBILIARIA';
$_SESSION['info'] = 'mobiliaria';
$_SESSION['imagen'] = 'MOBILIARIA.webp';
?>
...
<body>
    ...
    <main class="main__categoria">
        <h1 class="categoria1__titulo">
            <span class="restaurante">FABRICACIÓN MOBILIARIA</span>
            <br>
        ...
        <div class="logos">
            <div class="logos-slide">
                <img src="../../public/imagenes/moviliaria/AnyConv.com__MOBILIARIA UNO.jpg.webp" />
                <img src="../../public/imagenes/moviliaria/AnyConv.com__MOBILIARIO DOS.jpeg.webp" />
                <img src="../../public/imagenes/moviliaria/AnyConv.com__MOBILIARIO TRES.jpg.webp" />
                <img src="../../public/imagenes/moviliaria/AnyConv.com__MOBILIARIO CUATRO.jpeg.webp" />
            </div>
        </div>
        ...
        <div class="container-main">
            ...
            <div class="text2">
                ...
                <a class="action-button"
                    href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Fabricación%20Mobiliaria">CREA
                    AQUÍ TU DISEÑO</a>
            </div>
        </div>
