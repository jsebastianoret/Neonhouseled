<?php
session_start();
$_SESSION['servicio'] = 'DECORACIÓN Y REMODELACIÓN';
$_SESSION['info'] = 'decoracion';
$_SESSION['imagen'] = 'DECORACION.webp';
?>
...
<body>
    ...
    <main class="main__categoria">
        <h1 class="categoria1__titulo">
            <span class="restaurante">DISEÑO COMERCIAL</span>
            <br>
        ...
        <div class="logos">
            <div class="logos-slide">
                <img src="../../public/imagenes/decoracion/DC-1.jfif" />
                <img src="../../public/imagenes/decoracion/AnyConv.com__SANGUCHERIA.jpg.webp" />
                <img src="../../public/imagenes/decoracion/AnyConv.com__RESTAURANTE JAPONES.jpg.webp" />
                <img src="../../public/imagenes/decoracion/AnyConv.com__SALON SPA.jpg.webp" />
            </div>
        </div>
        ...
        <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/decoracion/AnyConv.com__CEVICHERIA.webp" class="d-block w-100"
                        alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/decoracion/AnyConv.com__SANGUCHERIA.jpg.webp" class="d-block w-100"
                        alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/decoracion/AnyConv.com__RESTAURANTE JAPONES.jpg.webp"
                        class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/decoracion/AnyConv.com__SALON SPA.jpg.webp" class="d-block w-100"
                        alt="Diseño Exterior">
                </div>
            </div>
        ...
        <div class="container-main">
            ...
            <div class="text2">
                ...
                <a class="action-button"
                    href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Diseño%20Comercial">CREA
                    AQUÍ TU DISEÑO</a>
            </div>
        </div>
