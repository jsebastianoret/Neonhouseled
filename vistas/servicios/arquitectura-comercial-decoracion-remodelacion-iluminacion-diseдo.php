...
<body>
    ...
    <main class="main__categoria">
        <h1 class="categoria1__titulo">
            <span class="restaurante">ARQUITECTURA COMERCIAL</span>
            <br>
        ...
        <div class="logos">
            <div class="logos-slide">
                <img src="../../public/imagenes/arquitectura/AC-1.png" />
                <img src="../../public/imagenes/arquitectura/AC-2.png" />
        ...
        <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/arquitectura/1.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/arquitectura/2.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/arquitectura/3.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/arquitectura/AnyConv.com__BARRA JUGUERIA..webp"
        ...
        <div class="container-main">
            ...
            <div class="text2">
                ...
                <a class="action-button"
                    href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Arquitectura%20Comercial">CREA
                    AQUÍ TU DISEÑO</a>
            </div>
