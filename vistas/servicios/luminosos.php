...
<body>
    ...
    <main class="main__categoria">
        <h1 class="categoria1__titulo">
            <span class="restaurante">LETREROS LUMINOSOS</span>
            <br>
        ...
        <div class="logos">
            <div class="logos-slide">
                <img src="../../public/imagenes/luminosos/LL-1.jpg" />
                <img src="../../public/imagenes/luminosos/LL-2.jpg" />
                <img src="../../public/imagenes/luminosos/LL-3.jpg" />
                <img src="../../public/imagenes/luminosos/LL-4.jpg" />
            </div>
        </div>
        ...
        <div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/luminosos/AnyConv.com__LETRERO LUMINOSO UNO.jpg.webp"
                        class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/luminosos/AnyConv.com__LETRRERO LUMINOSO ODS.jpg.webp"
                        class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/luminosos/AnyConv.com__LETRERO LUMINOSO TRES.jpg.webp"
                        class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/luminosos/AnyConv.com__LETRERO LUMINOSO CUATRO.jpg.webp"
                        class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
        ...
        <div class="container-main">
            ...
            <div class="text2">
                ...
                <a class="action-button"
                    href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Letreros%20Luminosos">CREA
                    AQUÍ TU DISEÑO</a>
            </div>
        </div>
