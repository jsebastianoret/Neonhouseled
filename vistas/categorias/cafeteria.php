<?php
session_start();
$_SESSION['categoria'] = 'CAFETERÍA Y JUGUERÍA';
$_SESSION['info'] = 'cafeteria';
$_SESSION['imagen'] = 'CAFETERIA Y JUGUERIA.jpg';
?>
...
<head>
    ...
    <meta name="description" content="¿Quieres que tu negocio sea un éxito? Transforma y personaliza el diseño y la decoración de tu cafetería/ juguería con nosotros para cautivar a más clientes. ¡Contáctanos ahora!"/>
    <!-- Google tag (gtag.js) -->
    ...
    <title>Estilos en Cafetería y Juguería: Remodelación que impacta </title>
...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        ...
        <span class="restaurante">CAFETERÍA Y JUGUERÍA</span> 
        <br> 
        ...
        <div class="logos">
          <div class="logos-slide">
            <img src="../../public/imagenes/Slider/CAFETERIA Y JUGUERIA/decoracion.webp" />
            <img src="../../public/imagenes/Slider/CAFETERIA Y JUGUERIA/remodelacion.webp" />
            <img src="../../public/imagenes/Slider/CAFETERIA Y JUGUERIA/diseño-interior.webp" />
            <img src="../../public/imagenes/Slider/CAFETERIA Y JUGUERIA/diseño-exterior.webp" />
          </div>
        </div>
...
<div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/CAFETERIA Y JUGUERIA/decoracion.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/CAFETERIA Y JUGUERIA/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/CAFETERIA Y JUGUERIA/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/CAFETERIA Y JUGUERIA/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <p class="action-title">¡HAZ UN CAMBIO TOTAL YA!</p>
        ...
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Cafetería%20y%20Juguería">TRANSFORMA TU LOCAL</a>
    </div>
</div>
