...
<head>
    ...
    <meta name="description" content="¿Quieres atraer más clientes a tu fuente de soda? Transformamos tu fuente de soda donde reflejen en espacios auténticos y atractivos  ¡Contacta ya!"/>
    <!-- Google tag (gtag.js) -->
    ...
    <title>Remodelación de fuente de soda: mejora tu imagen</title>
...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        ...
        <span class="restaurante">FUENTE DE SODA</span> 
        <br> 
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/FUENTE DE SODA/decoracion.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/FUENTE DE SODA/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/FUENTE DE SODA/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/FUENTE DE SODA/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <div class="text1">
        ...
        <h2 class="welcom__item__titulo">SUMÉRGETE EN LA NOSTALGIA DE LAS FUENTES DE SODA CLÁSICAS CON NUESTRO DISEÑO DE INTERIORES QUE COMBINA LO RETRO CON LO CONTEMPORÁNEO</h2>
        <h3 class="welcom__item__text">SI DESEA REVITALIZAR SU AMBIENTE PARA CREAR UNA EXPERIENCIA DONDE LOS RECUERDOS SE MEZCLEN CON LA MODERNIDAD, NUESTRO ENFOQUE ES PERFECTO PARA TI</h3>
    ...
    <div class="text2">
    <p class="action-title">¡TU NUEVA IMAGEN TE ESPERA!</p>
        <button class="action-button" id="openModalButton">TENDENCIAS ACTUALES AQUI</button>
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Fuente%20de%20Soda">TRANSFORMA TU LOCAL</a>
    </div>
</div>
