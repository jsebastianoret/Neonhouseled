<?php
session_start();
$_SESSION['categoria'] = 'FAST FOOD';
$_SESSION['info'] = 'fastfood';
$_SESSION['imagen'] = 'FAST FOOD.jpg';
?>
...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        ...
        <span class="restaurante">FAST FOOD</span> 
        <br> 
        ...
        <div class="logos">
          <div class="logos-slide">
            <img src="../../public/imagenes/Slider/FAST FOOD/decoracion.webp" />
            <img src="../../public/imagenes/Slider/FAST FOOD/remodelacion.webp" />
            <img src="../../public/imagenes/Slider/FAST FOOD/diseño-interior.webp" />
            <img src="../../public/imagenes/Slider/FAST FOOD/diseño-exterior.webp" />
          </div>
        </div>
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/FAST FOOD/decoracion.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/FAST FOOD/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/FAST FOOD/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/FAST FOOD/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <p class="action-title">¡TU TRANSFORMACIÓN COMIENZA AQUÍ!</p>
        ...
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Fast%20Food">TRANSFORMA TU LOCAL</a>
    </div>
</div>
