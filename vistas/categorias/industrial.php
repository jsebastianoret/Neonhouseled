...
<h1 class="categoria1__titulo">
        <span class="restaurante">ESTILO INDUSTRIAL</span> 
        <br> 
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/INDUSTRIAL/1.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/INDUSTRIAL/2.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/INDUSTRIAL/3.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/INDUSTRIAL/4.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <div class="text1">
        ...
        <h2 class="welcom__item__titulo">DESCUBRE LA BELLEZA EN LA SIMPLICIDAD CON NUESTRO ENFOQUE EN EL ESTILO INDUSTRIAL</h2>
        <h3 class="welcom__item__text">SI ERES DUEÑO DE UN ESTABLECIMIENTO Y BUSCAS TRANSFORMAR TUS ESPACIOS EN OBRAS MAESTRAS MODERNAS CON UN TOQUE URBANO O VINTAGE, NUESTRO DISEÑO DE INTERIORES ES TU MEJOR OPCIÓN</h3>
    ...
    <div class="text2">
    <p class="action-title">¡TRANSFORMA TU VISIÓN EN REALIDAD YA! </p>
        <button class="action-button" id="openModalButton">NUESTROS MEJORES DISEÑOS</button>
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Estilo%20Industrial">TRANSFORMA TU LOCAL</a>
    </div>
</div>
