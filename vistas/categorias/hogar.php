<?php
session_start();
$_SESSION['categoria'] = 'HOGAR';
$_SESSION['info'] = 'hogar';
$_SESSION['imagen'] = 'HOGAR.jpeg';
?>
...
<h1 class="categoria1__titulo">
        <span class="restaurante">HOGAR</span> 
        <br> 
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/HOGAR/decoracion.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/HOGAR/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/HOGAR/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/HOGAR/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <div class="text1">
        ...
        <h2 class="welcom__item__titulo">TRANSFORMA TU CASA EN EL HOGAR DE TUS SUEÑOS CON NUESTRO DISEÑO DE INTERIORES PERSONALIZADO</h2>
        <h3 class="welcom__item__text"> SI DESEAS MEJORAR LA FUNCIONALIDAD Y ESTÉTICA DE TUS ESPACIOS, TRABAJAMOS CONTIGO PARA REFLEJAR TU ESTILO, PERSONALIDAD Y COMODIDAD</h3>
        <h3 class="welcom__item__contacto">¡¡NO BUSQUES MÁS, SOMOS LA MEJOR OPCIÓN PARA CONVERTIR TU CASA EN UN LUGAR ÚNICO Y ACOGEDOR!!</h3>
    </div>
    <div class="curvas">
    ...
    <div class="text2">
    <p class="action-title">¡TU HOGAR MERECE LO MEJOR, NO ESPERES MÁS!        </p>
        <button class="action-button" id="openModalButton">NUESTROS MEJORES DISEÑOS</button>
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Hogar">TRANSFORMA TU HOGAR</a>
    </div>
</div>
