<?php
session_start();
$_SESSION['categoria'] = 'DEPARTAMENTO';
$_SESSION['info'] = 'departamento';
$_SESSION['imagen'] = 'DEPARTAMENTO.jpg';
?>
...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        ...
        <span class="restaurante">DEPARTAMENTO</span> 
        <br> 
        ...
        <div class="logos">
          <div class="logos-slide">
            <img src="../../public/imagenes/Slider/DEPARTAMENTO/decoracion.webp" />
            <img src="../../public/imagenes/Slider/DEPARTAMENTO/remodelacion.webp" />
            <img src="../../public/imagenes/Slider/DEPARTAMENTO/diseño-interior.webp" />
            <img src="../../public/imagenes/Slider/DEPARTAMENTO/diseño-exterior.webp" />
          </div>
        </div>
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/DEPARTAMENTO/decoracion.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/DEPARTAMENTO/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/DEPARTAMENTO/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/DEPARTAMENTO/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <div class="text1">
        ...
        <h2 class="welcom__item__titulo">TRANSFORMA TU ESPACIO EN UN REFLEJO DE TU ESTILO Y PERSONALIDAD</h2>
        <h3 class="welcom__item__text">SI SIENTES QUE TU DEPARTAMENTO CARECE DE CALIDEZ Y FUNCIONALIDAD, PERMÍTENOS RENOVARLO Y CREAR UN LUGAR QUE REALMENTE TE REPRESENTE, DONDE CADA RINCÓN CUENTA UNA HISTORIA Y CADA DETALLE ESTÁ CUIDADOSAMENTE DISEÑADO PARA ADAPTARSE A TU VIDA</h3>
        <h3 class="welcom__item__contacto">¡¡RENUEVA TU ESPACIO CON NOSOTROS!!</h3>
    </div>
    <div class="curvas">
    ...
    <p class="action-title">¡RENUEVA TU ESTILO HOY MISMO!</p>
        ...
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Departamento">DISEÑA TU DEPARTAMENTO</a>
    </div>
</div>
