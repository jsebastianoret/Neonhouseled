...
<h1 class="categoria1__titulo">
        <span class="restaurante">PANADERÍA Y PASTELERÍA</span> 
        <br> 
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/PANADERIA Y PASTELERIA/decoracion.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/PANADERIA Y PASTELERIA/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/PANADERIA Y PASTELERIA/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/PANADERIA Y PASTELERIA/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <div class="text1">
        ...
        <h2 class="welcom__item__titulo">TRANFORMA TU PANADERÍA CON NUESTROS EXPERTOS EN DISEÑO DE INTERIORES</h2>
        <h3 class="welcom__item__text">BRINDAMOS LA SOLUCIÓN DESDE EL PRIMER CONTACTO QUE HACES CON NOSOTROS. CREAREMOS UN AMBIENTE ACOGEDOR Y ATRACTIVO QUE INVITARÁ A TUS CLIENTE A REGRESAR UNA Y OTRA VEZ, AUMENTANDO TUS VENTAS Y LA SATISFACCIÓN DEL CLIENTE</h3>
        <h3 class="welcom__item__contacto">¡CONTACTANOS HOY MISMO CON NUESTRO SERVICIOS PERSONALIZADOS!</h3>
    </div>
    <div class="curvas">
    ...
    <div class="text2">
    <p class="action-title">¡TU NUEVA PANADERÍA TE ESPERA!</p>
        <button class="action-button" id="openModalButton">TENDENCIAS ACTUALES AQUI</button>
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Panadería">TRANSFORMA TU PANADERÍA Y PASTELERÍA </a>
    </div>
</div>
