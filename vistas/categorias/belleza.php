...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        ...
        <span class="restaurante">BELLEZA</span> 
        <br> 
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/SALON BELLEZA Y BARBERIA/decoracion.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/SALON BELLEZA Y BARBERIA/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/SALON BELLEZA Y BARBERIA/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/SALON BELLEZA Y BARBERIA/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <div class="text1">
        ...
        <h2 class="welcom__item__titulo">SI TUS CLIENTES A MENUDO EXPERIMENTAN TIEMPOS DE ESPERA LARGOS O UNA SENSACIÓN DE DESORGANIZACIÓN</h2>
        <h3 class="welcom__item__text"> DÉJANOS CONVERTIR ESA DEBILIDAD EN UNA FORTALEZA. DISTRIBUIMOS LOS ESPACIOS DE MANERA ESTRATÉGICA PARA AUMENTAR LA PRODUCTIVIDAD Y LA SATISFACCIÓN DE TUS CLIENTES</h3>
        <h3 class="welcom__item__contacto">¡OFRECEMOS LO MEJOR EN DISEÑO DE INTERIOR, CONTACTA A TU SERVICIO DE PRIMER NIVEL !</h3>
    </div>
    <div class="curvas">
    ...
    <p class="action-title">¡HAZ BRILLAR TU SALÓN HOY!</p>
        ...
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Belleza">TRANSFORMA TU SALÓN DE BELLEZA</a>
    </div>
</div>
