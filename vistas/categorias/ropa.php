...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        ...
        <span class="restaurante">TIENDA DE ROPA</span> 
        <br> 
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/ROPA/decoracion.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/ROPA/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/ROPA/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/ROPA/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <div class="text1">
        ...
        <h2 class="welcom__item__titulo">SI TU TIENDA DE ROPA NO OFRECE UNA EXPERIENCIA ÚNICA PARA TUS CLIENTES POTENCIALES</h2>
        <h3 class="welcom__item__text">EN NUESTRO EQUIPO, SOMOS EXPERTOS EN DISEÑO Y TRANSFORMACIÓN. PODEMOS CONVERTIR TU TIENDA EN UN DESTINO DE MODA QUE DESTAQUE ENTRE LA COMPETENCIA</h3>
        <h3 class="welcom__item__contacto"> ¡AUMENTA TUS VENTAS, CONTÁCTANOS DE INMEDIATO!</h3>
    </div>
    <div class="curvas">
    ...
    <div class="text2">
    <p class="action-title">¡TRANSFORMA TU TIENDA DE ROPA YA! </p>
        <button class="action-button" id="openModalButton">ULTIMAS TENDENCIAS </button>
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Tienda%20de%20Ropa">TRANSFORMA TU TIENDA DE ROPA </a>
    </div>
</div>
