<?php
session_start();
$_SESSION['categoria'] = 'CEVICHERÍA';
$_SESSION['info'] = 'cevicheria';
$_SESSION['imagen'] = 'CEVICHERIA.jpeg';
?>
...
<head>
    ...
    <title>Remodela tu cevichería: diseño moderno</title>
...
<body>
    ...
    <main class="main__categoria">
        ...
        <span class="restaurante">CEVICHERÍA</span> 
        <br> 
...
<div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/CEVICHERIA/decoracion.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/CEVICHERIA/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/CEVICHERIA/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/CEVICHERIA/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <div class="text1">
        ...
        <h2 class="welcom__item__titulo">DESCUBRE CÓMO TRANSFORMAMOS TU CEVICHERÍA EN UN DESTINO GASTRONÓMICO INCOMPARABLE.</h2>
        <h3 class="welcom__item__text"> SI SIENTES QUE TU CEVICHERÍA NECESITA RENOVACIÓN PARA ATRAER A MÁS CLIENTES Y COMPETIR CON OTROS RESTAURANTES, SUMÉRGETE EN UNA EXPERIENCIA ÚNICA DONDE EL ARTE DEL CEVICHE SE FUSIONA CON UN DISEÑO DE INTERIORES QUE DESPIERTA TODOS TUS SENTIDOS</h3>
        <h3 class="welcom__item__contacto">¡¡NO ESPERES MÁS, NHL ES TU MEJOR OPCIÓN!!</h3>
    </div>
    <div class="curvas">
    ...
    <div class="text2">
    <p class="action-title">¡RENUEVA TU ESPACIO YA! </p>
        <button class="action-button" id="openModalButton">TENDENCIAS ACTUALES AQUI</button>
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Cevichería">DISEÑA TU CEVICHERIA</a>
    </div>
</div>
