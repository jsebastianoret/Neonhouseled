<?php
session_start();
$_SESSION['categoria'] = 'HOTELES';
$_SESSION['info'] = 'hoteles';
$_SESSION['imagen'] = 'HOTELES.jpg';
?>
...
<h1 class="categoria1__titulo">
        <span class="restaurante">HOTELES</span> 
        <br> 
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/HOTELES/decoracion.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/HOTELES/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/HOTELES/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/HOTELES/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <div class="text2">
    <p class="action-title">¡CREA UN AMBIENTE ÚNICO HOY MISMO!</p>
        <button class="action-button" id="openModalButton">DISEÑOS UNICOS AQUI</button>
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Hotelería">TRANSFORMA TU HOTEL</a>
    </div>
</div>
