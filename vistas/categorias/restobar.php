...
<head>
    ...
    <meta name="description" content="Creamos diseños que atraen y retienen clientes a tu restobar. Transforma tu espacio en un destino de sabor y estilo."/>
    <!-- Google tag (gtag.js) -->
    ...
    <title>Renueva tu restobar: diseño moderno y elegante</title>
...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        ...
        <span class="restaurante">RESTOBAR</span> 
        <br> 
        ...
        <div class="logos">
          <div class="logos-slide">
            <img src="../../public/imagenes/Slider/RESTOBAR/decoracion.webp" />
            <img src="../../public/imagenes/Slider/RESTOBAR/remodelacion.webp" />
            <img src="../../public/imagenes/Slider/RESTOBAR/diseño-interior.webp" />
            <img src="../../public/imagenes/Slider/RESTOBAR/diseño-exterior.webp" />
          </div>
        </div>
...
<div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/RESTOBAR/decoracion.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/RESTOBAR/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/RESTOBAR/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/RESTOBAR/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <div class="text1">
        ...
        <h2 class="welcom__item__titulo">SI TU RESTOBAR CARECE DE AMBIENTE Y NO SE DESTACA LO SUFICIENTE ENTRE TU COMPETENCIA</h2>
        <h3 class="welcom__item__text">   DÉJANOS CONVERTIR ESAS DEBILIDADES EN UNA FORTALEZA,CREAMOS UN AMBIENTE RELAJADO Y ATRACTIVO QUE HARÁ QUE TUS CLIENTES REGRESEN UNA Y OTRA VEZ</h3>
        <h3 class="welcom__item__contacto">¡CONTÁCTANOS!</h3>
    </div>
    <div class="curvas">
    ...
    <div class="text2">
    <p class="action-title">¡HAZ QUE TU RESTOBAR DESTAQUE!</p>
        <button class="action-button" id="openModalButton">NUESTROS MEJORES DISEÑOS</button>
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Restobar"> TRANSFORMA TU RESTOBAR</a>
    </div>
</div>
