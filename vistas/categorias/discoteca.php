<?php
session_start();
$_SESSION['categoria'] = 'DISCOTECA';
$_SESSION['categoria'] = 'discoteca';
$_SESSION['imagen'] = 'DISCOTECA.jpeg';
?>
...
.welcom__item__text {
            font-size: 23px; /* Ajusta este valor según el tamaño deseado */
        }
</style>
<body>
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        ...
        <span class="restaurante">DISCOTECA</span> 
        <br> 
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/DISCOTECA/decoracion.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/DISCOTECA/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/DISCOTECA/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/DISCOTECA/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <div class="text1">
        ...
        <h2 class="welcom__item__titulo">DESDE LA PISTA DE BAILE HASTA LOS RINCONES MÁS ÍNTIMOS, NUESTRA VISIÓN TRANSFORMARÁ TU DISCOTECA EN UN ESCENARIO VIBRANTE</h2>
        <h3 class="welcom__item__text"> SI SIENTES QUE TU DISCOTECA NECESITA MÁS ENERGÍA Y ATRACTIVO PARA COMPETIR EN EL MERCADO NOCTURNO, PERMÍTENOS ELECTRIFICAR TUS NOCHES CON UN DISEÑO DE INTERIORES QUE LO HARÁ BRILLAR CADA MOMENTO</h3>
        <h3 class="welcom__item__contacto">¡¡RENUEVA TU DISCOTECA CON NOSOTROS!!</h3>
    </div>
    <div class="curvas">
    ...
    <div class="text2">
    <p class="action-title">¡TU TRANSFORMACIÓN COMIENZA AQUÍ!</p>
        <button class="action-button" id="openModalButton">NUESTROS MEJORES DISEÑOS</button>
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Discoteca">TRANSFORMA TU DISCOTECA</a>
    </div>
</div>
