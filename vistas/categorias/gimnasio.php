<?php
session_start();
$_SESSION['categoria'] = 'GIMNASIO';
$_SESSION['info'] = 'gimnasio';
$_SESSION['imagen'] = 'GIMNASIO.jpg';
?>
...
<h1 class="categoria1__titulo">
        <span class="restaurante">GIMNASIO</span> 
        <br> 
...
<div id="carouselExample" class="carousel slide" data-bs-ride="carousel">
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/GIMNASIO/decoracion.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/GIMNASIO/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/GIMNASIO/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/GIMNASIO/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <div class="text1">
        ...
        <h2 class="welcom__item__titulo">DESCUBRE CÓMO NUESTRO DISEÑO DE INTERIORES PUEDE ENERGIZAR TU GIMNASIO</h2>
        <h3 class="welcom__item__text"> SI ESTÁS BUSCANDO MEJORAR LA EXPERIENCIA DE TUS CLIENTES Y MAXIMIZAR SU RENDIMIENTO Y BIENESTAR, NUESTRO ENFOQUE ES TU MEJOR OPCIÓN. CREAMOS AMBIENTES FUNCIONALES Y MOTIVADORES QUE INSPIRAN A ALCANZAR NUEVAS METAS, ASEGURANDO UNA ATMÓSFERA VIBRANTE Y POSITIVA</h3>
    ...
    <div class="text2">
    <p class="action-title">¡RENUEVA, TRANSFORMA, Y SORPRENDE!</p>
        <button class="action-button" id="openModalButton">PROYECTOS INNOVADORES</button>
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Gimnasio">DISEÑA TU GIMNASIO</a>
    </div>
</div>
