<?php
session_start();
$_SESSION['categoria'] = 'VETERINARIA';
$_SESSION['info'] = 'veterinaria';
$_SESSION['imagen'] = 'VETERINARIA.jpg';
?>
...
<?php require_once "../layout/header.php" ?>
    ...
    <main class="main__categoria">
        ...
        <span class="restaurante">VETERINARIA</span> 
        <br> 
        ...
        <div class="carousel-indicators">
            ...
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="../../public/imagenes/Slider/VETERINARIA/decoracion.webp" class="d-block w-100" alt="Decoración">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/VETERINARIA/remodelacion.webp" class="d-block w-100" alt="Remodelación">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/VETERINARIA/diseño-interior.webp" class="d-block w-100" alt="Diseño Interior">
                </div>
                <div class="carousel-item">
                    <img src="../../public/imagenes/Slider/VETERINARIA/diseño-exterior.webp" class="d-block w-100" alt="Diseño Exterior">
                </div>
            </div>
    ...
    <div class="text1">
        ...
        <h2 class="welcom__item__titulo">SI TU VETERINARIA ACTUAL NO OFRECE UN AMBIENTE ACOGEDOR Y SEGURO ES HORA DE UNA TRANSFORMACIÓN</h2>
        <h3 class="welcom__item__text"> CON NUESTRO EQUIPO DE EXPERTOS EN DISEÑO, CREAMOS ESPACIOS QUE NO SOLO SON CÓMODOS, SINO TAMBIÉN PREPARADOS PARA UNA VARIEDAD DE SERVICIOS QUE TU NEGOCIO PUEDA OFRECER</h3>
        <h3 class="welcom__item__contacto">¡CONTACTA A TU SERVICIO DE PRIMER NIVEL Y HAZ QUE TU VETERINARIA SEA UN LUGAR AL QUE TODOS QUIERAN VOLVER!</h3>
    </div>
    <div class="curvas">
    ...
    <div class="text2">
    <p class="action-title">¡HAZ DE TU VETERINARIA ALGO EXTRAORDINARIO! </p>
        <button class="action-button" id="openModalButton">DISEÑOS UNICOS AQUI</button>
        <a class="action-button" href="https://api.whatsapp.com/send?phone=51936910425&text=Apoyo%20sobre%20mi%20proyecto%20de%20Veterinaria">TRANSFORMA TU VETERINARIA</a>
    </div>
</div>
