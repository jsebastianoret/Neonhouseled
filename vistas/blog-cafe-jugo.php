...
try {
    ...
    $categoria = isset($_GET['categoria']) ? $_GET['categoria'] : 'Cafeteria y Jugueria'; 
...
<head>
    ...
    <title>Blog - CAFETERIA Y JUGUERIA</title>    
            ...
            <div class="contenedor__articulos__swiper">
                <div class="swiper mySwiper">
                    <div class="swipe-slider__texto">
                        <h3> CAFETERIA Y JUGUERIA</h3>
                        <p>En esta sección encontrarás temas relacionados con el diseño de interiores enfocado en entornos de trabajo profesionales de cafeterias y juguerias.</p>
                    </div>
                    <div class="swiper-wrapper">
                        <div class="swiper-slide">
                            <img src="../public/imagenes/galeria-imagenes/cafeteria/1.webp" alt="Imagen1-slider-blog">
                        </div>
                        <div class="swiper-slide">
                            <img src="../public/imagenes/galeria-imagenes/cafeteria/1.webp" alt="Imagen2-slider-blog">
                        </div>
                        <div class="swiper-slide">
                            <img src="../public/imagenes/galeria-imagenes/cafeteria/1.webp" alt="Imagen3-slider-blog">
                        </div>
                    </div>
                </div>
                ...
                <?php foreach ($articulos as $articulo) { ?>
                    ...
                    <a href="<?php echo htmlspecialchars('../vistas/blogs/mediaBlogs' . $articulo['id']). '.php'; ?>">
                            ...
                            <div class="articulos__item__texto">
                                <p><?php echo htmlspecialchars('Cafeteria y Jugueria'); ?></p>
