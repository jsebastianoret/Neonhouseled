...
try {
    ...
    $categoria = isset($_GET['categoria']) ? $_GET['categoria'] : 'dormitorio para niños'; 
...
<head>
    ...
    <title>Blog - DORMITORIO PARA NIÑOS</title>    
            ...
            <div class="contenedor__articulos__swiper">
                <div class="swiper mySwiper">
                    <div class="swipe-slider__texto">
                        <h3>DORMITORIO PARA NIÑOS</h3>
                        <p>En esta sección encontrarás temas relacionados con el diseño de interiores enfocado en entornos de trabajo profesionales de dormitorios.</p>
                    </div>
                ...
                <?php foreach ($articulos as $articulo) { ?>
                    ...
                    <a href="<?php echo htmlspecialchars('../vistas/blogs/mediaBlogs' . $articulo['id']). '.php'; ?>">
                            ...
                            <div class="articulos__item__texto">
                                <p><?php echo htmlspecialchars('DORMITORIO PARA NIÑOS'); ?></p>
