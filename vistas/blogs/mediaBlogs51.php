        ...
        <body>
            ...
            <div class="blog-post">
                <div class="blog-container">
                    <span class="categoria">Categoría: POLLERÍA</span>
                    <header class="blog-header">
                        <h1>Diseño de Restaurantes: Creando Espacios que Seducen al Paladar y al Corazón</h1>
                        <div class="blog-banner">
                            <img src="../../public/imagenes/imagesBlogBd/comidassss.jpg" alt="Imagen Portada" class="imgprin">
                            <div class="text-box">
                    ...
                    <main class="blog-main">
                        <article class="blog-article">
                            <hr>
                            <div class="meta">
                                <span id="f">Publicado: 2024-08-06 09:40:35</span>
                                <span id="hoy"></span>
                            </div>
                            <hr>
                            <div class="neon-logo">
                            ...
                            <div class="blog-body">
                                <img src="../../public/imagenes/imagesBlogBd/b12-moda.jpg" alt="Imagen Principal">
                                <div>
                            ...
                            <div class="blog-body">
                                ...
                                <br>
                                <br>
                                <img src="../../public/imagenes/imagesBlogBd/pul.jpg" alt="Imagen Secundaria">
                            </div>
