...
try {
    ...
    $categoria = isset($_GET['categoria']) ? $_GET['categoria'] : 'salon belleza y barberia'; 
...
<head>
    ...
    <title>Blog - SALON BELLEZA Y BARBERIA</title>    
            ...
            <div class="contenedor__articulos__swiper">
                <div class="swiper mySwiper">
                    <div class="swipe-slider__texto">
                        <h3>SALON BELLEZA Y BARBERIA</h3>
                ...
                <?php foreach ($articulos as $articulo) { ?>
                    ...
                    <a href="<?php echo htmlspecialchars('../vistas/blogs/mediaBlogs' . $articulo['id']). '.php'; ?>">
                            ...
                            <div class="articulos__item__texto">
                                <p><?php echo htmlspecialchars('SALON BELLEZA Y BARBERIA'); ?></p>
